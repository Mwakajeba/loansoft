...
Route::get('/reports/loans/loan-report', [App\Http\Controllers\LoanReportController::class, 'loanSummaryReport'])->middleware('auth')->name('reports.loans.loan_report');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('customers/bulk-upload/progress', [CustomerController::class, 'bulkUploadProgress'])->name('customers.bulk-upload.progress');
