...
<body>
    ...
    <div class="header">
        ...
        <div class="report-info"><strong>Period:</strong> {{ \Carbon\Carbon::parse($start_date)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($end_date)->format('d/m/Y') }} | <strong>Report Date:</strong> {{ $generated_date ?? \Carbon\Carbon::now()->format('d/m/Y H:i:s') }}</div>
    </div>
