                        ...
                        <div class="card-body">
                            ...
                            <form id="receiptVoucherForm"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="loan_id" class="form-label fw-bold">
                                                <i class="bx bx-hash me-1"></i>Reference (Loan ID)
                                            </label>
                                            <input type="text" class="form-control" id="loan_id" name="loan_id" value="{{ $loan->id }}" readonly>
                                            <div class="form-text">Loan ID for this receipt (Do not change)</div>
                                        </div>
                                    </div>
                                </div>
